...
/**
 * onAutoExposure(error: String?, enabled: Boolean) ...
 * Should callback the error as function, let the view decide what to show ?! (see IFirmwareRegister onAddressNotSet())
 */
interface ISensor {
