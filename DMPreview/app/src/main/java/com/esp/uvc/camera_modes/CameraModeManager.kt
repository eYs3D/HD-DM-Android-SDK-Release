...
object CameraModeManager {
    ...
    // 8036, 8037, 8052, 8059, 8062, 8062 IMU, 8071, Hypatia2, Mary, 8053
    val SUPPORTED_PID_LIST = intArrayOf(0x0120, 0x0121, 0x0137, 0x0146, 0x0162, 0x0163, 0x0160, 0x0173, 0x0174, 0x0138)
