...
import com.esp.uvc.main.settings.firmware_register.FirmwareRegisterActivity
import com.esp.uvc.main.settings.firmware_table.FirmwareTableActivity
import com.esp.uvc.main.settings.firmware_version.FirmwareVersionActivity
import com.esp.uvc.main.settings.module_sync.ModuleSyncActivity
import com.esp.uvc.main.settings.preview_settings.PreviewSettingsActivity
...
class SettingsMainActivity : AppCompatActivity() {
    ...
    private fun initViews() {
        layout_preview_image.setOnClickListener {
            PreviewSettingsActivity.startInstance(this)
        }
